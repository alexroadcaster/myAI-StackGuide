...
| `V1-TAX-001` | Define the V1 taxonomy contract and controlled evolution rules for 60–90 categories. | `docs/V1_ROADMAP.md` Milestone 1 | Category IDs, labels, parent relationships, aliases, ownership, and duplicate rules are explicit. | Catalog Architect | `contract_verified` |
