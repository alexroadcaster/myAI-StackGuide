...
| R11 | Pin the paired card `2.0.0`, retrieval-policy `2.0.0`, index-format `2`, catalog and artifact hashes; reproduce candidate selection and fail closed on any mixed v1/v2 set. Remote overlay/compaction remains deferred. | CP-03, CP-06, CP-09, CP-11, CP-13, CP-16 |
