...
python -m unittest tests.test_catalog_v5_pipeline -v
...
- Every agent declares exactly three discovered skills without absolute path pinning.
- Codex strict-config reports no invalid project-scoped agent configuration.
