...
| P2: local useful vertical slice | CP-06-CP-11 | CP-06 build/package step is implemented and verified: 2,500 self-contained cards plus paired FTS v2 index/policy/manifest. After the CP-05-C fresh-session gate, CP-07 adds intake/state/preflight; bounded context, actual read-only v2 retrieval and integration report remain CP-08-11. |
