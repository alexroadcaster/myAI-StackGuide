...
| R07 | Positive numeric GitHub repository ID is canonical across card/index/result/evidence; catalog IDs are lineage and historical full-name aliases are separate. Upstream/catalog descriptions and creation/update/push/verified commit/release/sync/observation dates remain distinct. | CP-03, CP-06, CP-09, CP-10 |
